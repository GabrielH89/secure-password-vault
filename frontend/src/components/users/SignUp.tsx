    ...
    return (
        <div>
            <form className="signUpForm" onSubmit={handleSignUp}>
                ...
                <div className="formGroup">
                    <label>Email:</label>
                    <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} maxLength={600} required />
                </div>
                <div className="formGroup">
                    <label>Senha:</label>
                    <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} maxLength={300} required />
                    <p>A senha deve ter, no mínimo, 6 caracteres, incluindo números, letras maiúsculas, minúsculas e símbolos</p>
                </div>
                <div className="formGroup">
